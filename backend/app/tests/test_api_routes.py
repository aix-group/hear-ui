...
def sample_patient(sample_patient_data):
    ...
    return Patient(
        id=uuid4(), input_features=sample_patient_data, created_at=datetime.now(timezone.utc)
    )
...
class TestPatientRoutes:
    ...
    def test_predict_patient_no_features(self, mock_session):
        ...
        patient = Patient(id=uuid4(), input_features={}, created_at=datetime.now(timezone.utc))
...
class TestFeedbackRoutes:
    ...
    def test_create_feedback_success(self, mock_session, sample_feedback_data):
        ...
        expected_feedback = Feedback(
            id=uuid4(), created_at=datetime.now(timezone.utc), **sample_feedback_data
        )
    ...
    def test_read_feedback_found(self, mock_session, sample_feedback_data):
        ...
        feedback_id = uuid4()
        expected_feedback = Feedback(
            id=feedback_id, created_at=datetime.now(timezone.utc), **sample_feedback_data
        )
